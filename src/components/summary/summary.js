export default function Summary() {
    return (
        ...
        <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
            ...
            <h1 className="text-3xl dark:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">🎉 Thanks for your purchase 🎉</h1>
                    ...
                    <div className="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
                        ...
                        <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                            ...
                            <div className="flex w-full justify-center items-center md:justify-start md:items-start">
                                <button className="hover:bg-red dark:bg-red dark:text-red-800 dark:hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-800 py-5 w-96 md:w-full bg-red-800 text-base font-medium leading-4 text-white">Finish</button>
                            </div>
                        </div>
                    </div>
                </div>
